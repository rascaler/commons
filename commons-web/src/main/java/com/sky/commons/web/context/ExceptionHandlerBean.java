package com.sky.commons.web.context;
...
public class ExceptionHandlerBean implements Ordered {
	...
	public OuterResult handleThrowAble(HttpServletRequest servletRequest, Throwable ex) {
		...
		if (ex instanceof ServiceException) {
			...
			logger.error("业务出错(" + servletRequest.getRequestURI() + ")" + " code:" + serviceException.getCode() + ", msg:" + serviceException.getMsg(), serviceException);
			outerResult = new OuterResult(serviceException.getCode(), serviceException.getMsg());
			return outerResult;
		}
